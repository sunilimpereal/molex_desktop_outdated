  ...
  Widget scheduleDetail() {
    return Container(
      ...
      children: [
        ...
        feild(heading: "Order Id", value: widget.schedule.orderId, width: 0.1),
        feild(
            heading: "FG Part",
        ...
        feild(
            ...
            width: 0.08),
        feild(heading: "Color", value: "${widget.schedule.color}", width: 0.08),
        feild(
        ...
        feild(
            ...
            value: widget.schedule.currentDate == null
                ...
                : DateFormat("dd-MM-yyyy")
                    .format(widget.schedule.currentDate ?? DateTime.now()),
            width: 0.08)
      ],
    ));
  }
